...
with pd.ExcelWriter(r'D:/RAS_results/RAS2/vel_output.xlsx') as writer: 
    i=1
...
with pd.ExcelWriter(r'D:/RAS_results/RAS2/wse_output.xlsx') as writer: 
    i=1
...
with pd.ExcelWriter(r'D:/RAS_results/RAS2/min-El_output.xlsx') as writer: 
    i=1
