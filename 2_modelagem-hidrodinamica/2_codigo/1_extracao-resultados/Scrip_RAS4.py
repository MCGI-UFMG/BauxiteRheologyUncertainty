...
with pd.ExcelWriter(r'D:/RAS_results/RAS4/vel_output.xlsx') as writer: 
    i=1
...
with pd.ExcelWriter(r'D:/RAS_results/RAS4/wse_output.xlsx') as writer: 
    i=1
...
with pd.ExcelWriter(r'D:/RAS_results/RAS4/min-El_output.xlsx') as writer: 
    i=1
